    ...
    <div class="wrapper">
            ...
            <tr>
                ...
                <td>
                    <select name="category">
                        ...
                        <?php
                            //create pfp code to display categories from database
        ...
        <?php
                ...
                if(isset($_POST['submit']))
                {
                   ...
                   //for numerical we do not need to pass value insert quotes'' but for string value it is copulsory to add quotes''
