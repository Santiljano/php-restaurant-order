     ...
     <div class="wrapper">
        ...
        <?php 
            ...
            if(isset($_GET['id']))
            {
                ...
                //connect the rows to check whether the id is valid or not
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                //4.redirect manage category with message
                ...
                else
                {
                    ...
                    $_SESSION['update'] = "<div class='errorr'>Category Failed to Update.</div>";
                    header('location:' .SITEURL. 'admin/manage-category.php');
                }
            }
